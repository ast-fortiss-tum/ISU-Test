...
from isu.analysis.calculate_failures_found import calculate_failures_found
from isu.analysis.input_hv_coverage import calculate_input_hv_coverage
...
class SimulationResult(Result):
    ...
    def write_results(
        ...
        **kwargs
        ...
        # isu_output.write_tests_to_json(self, save_folder)
        # isu_output.write_tests_to_json(
        #     self, save_folder, critical_only=True, filename="all_critical_scenarios"
        # )
